...
router
  .group(() => {
    ...
    router.post('/api/campaigns/:campaignId/characters', [CharactersController, 'listCampaignCharacters'])
    router.post('/api/characters/:characterId/receive-buff', [CharactersController, 'receiveBuff'])

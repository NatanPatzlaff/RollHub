...
export default function VTTTabs({ tabs, activeTab, setActiveTab }: VTTTabsProps) {
  return (
    <div className="flex bg-[#09090B] px-2 pt-2 border-b border-[#27272A] gap-1 select-none overflow-x-auto no-scrollbar">
      ...
      <button className="flex items-center justify-center w-8 h-8 mt-1 ml-1 rounded-md text-[#A1A1AA] hover:bg-[#1C1C1E] hover:text-white transition-colors flex-shrink-0">

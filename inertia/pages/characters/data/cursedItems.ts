...
export const SPECIAL_CURSED_ITEMS: SpecialCursedItem[] = [
    ...
    {
        id: 'sangue-frasco-vitalidade',
        name: 'Frasco de Vitalidade',
        element: 'Sangue',
        category: 2,
        spaces: 1,
        description: 'Este pequeno recipiente de vidro possui uma tampa de metal gravada com um selo de Sangue. Você pode gastar 1 minuto e sofrer até 20 pontos de dano para encher o frasco com seu próprio sangue. Enquanto estiver no recipiente, seu sangue se mantém fresco. Você pode gastar uma ação padrão para beber o conteúdo do frasco e recuperar a mesma quantidade de PV que armazenou nele, mas deve passar em um teste de Fortitude (DT 20) para não ficar enjoado por uma rodada.'
    },
    {
        id: 'sangue-perola-sangue',
        name: 'Pérola de Sangue',
        element: 'Sangue',
        category: 2,
        spaces: 1,
        description: 'Uma esfera de aproximadamente 2cm de diâmetro, lisa e reluzente como uma pérola, mas de cor vermelho-vivo. Você pode gastar uma ação de movimento para forçar a pérola de Sangue contra a sua pele e absorvê-la, recebendo uma injeção de adrenalina que fornece +5 em testes de Agilidade, Força e Vigor e testes baseados nesses atributos até o final da cena. Ao final da cena, você precisa fazer um teste de Fortitude (DT 20). Se falhar, fica fatigado até o final do dia. Se falhar por 5 ou mais, sofre uma parada cardíaca e fica morrendo. Se morrer dessa forma, você se torna uma criatura de Sangue de VD similar ao seu NEX, à escolha do mestre.'
    },
    {
        id: 'sangue-punhos-enraivecidos',
        name: 'Punhos Enraivecidos',
        element: 'Sangue',
        category: 2,
        spaces: 1,
        description: 'Um par de soqueiras feitas de um metal vermelho vivo e gravado com vários símbolos de Sangue. Seus ataques desarmados causam +1d8 pontos de dano de Sangue e seu dano se torna letal. Sempre que acerta um ataque desarmado, pode fazer outro ataque desarmado contra o mesmo alvo, pagando 2 PE por cada ataque já realizado no turno. Ou seja, pode fazer o primeiro ataque extra gastando 2 PE, um segundo ataque extra gastando mais 4 PE e assim por diante, até errar um ataque ou não ter mais pontos de esforço.'
    },
    {
        id: 'sangue-seringa-transfiguracao',
        name: 'Seringa de Transfiguração',
        element: 'Sangue',
        category: 2,
        spaces: 1,
        description: 'Esta seringa é feita de um material estranho e de aparência orgânica, cheio de veias pulsantes. Você pode gastar uma ação padrão para sugar o sangue de um alvo adjacente e encher a seringa (se o alvo não for voluntário, você precisa acertá-lo com um ataque corpo a corpo). Se houver sangue na seringa, você pode gastar uma ação padrão para injetá-lo em qualquer outra pessoa adjacente, que terá sua aparência transfigurada para a do dono do sangue, como se estivesse sob efeito do ritual Distorcer Aparência, com duração aumentada para um dia. Quando o efeito acabar, o alvo deve rolar 1d6. Em um resultado 1, o processo de voltar à sua aparência é especialmente traumático, danificando seus músculos e órgãos e fazendo com que perca 1 PV permanentemente.'
    },
    // MORTE
    {
        id: 'morte-amarras-mortais',
        name: 'Amarras Mortais',
        element: 'Morte',
        category: 2,
        spaces: 1,
        description: 'Um par de correntes de ferro negro que se enrolam nos antebraços do usuário como um bracelete. Uma vez por rodada, você pode gastar uma ação padrão e 2 PE para usar a manobra agarrar contra um alvo Grande ou menor em alcance curto, recebendo +10 em seu teste oposto. Você também pode usar uma ação de movimento para puxar um alvo agarrado para perto, deixando-o adjacente.'
    },
    {
        id: 'morte-casaco-lodo',
        name: 'Casaco de Lodo',
        element: 'Morte',
        category: 2,
        spaces: 1,
    ...
    },
    {
        ...
        category: 2,
        spaces: 1,
        description: 'Este punhal possui a lâmina completamente negra e a empunhadura em espiral. Você pode gastar uma ação completa para apunhalar uma pessoa que esteja morrendo. Ao fazer isso, você mata o alvo e a Coletora absorve os resquícios do tempo de vida dela, armazenando 1d8 PE. O punhal pode armazenar um total de 20 PE, que você pode usar como se fossem seus desde que esteja portando a adaga a pelo menos uma semana. Enquanto portar a adaga, você é acometido por pesadelos sobre o sofrimento final de suas vítimas e sempre tem condições de descanso ruins, independente de onde ou como descansar.'
    },
    {
        id: 'morte-cranio-espiral',
        name: 'Crânio Espiral',
        element: 'Morte',
        category: 2,
        spaces: 1,
        description: 'Um crânio envelhecido, apodrecido e distorcido em um formato espiral. Lodo escorre de seus olhos vazios, como lágrimas negras. Uma vez por rodada, se estiver empunhando o crânio, você pode gastar uma ação livre para ativá-lo. Quando faz isso, você recebe uma ação padrão adicional na rodada. Sempre que usa o crânio, você deve fazer um teste de Vontade (DT 15 + 5 por uso adicional no mesmo dia). Se falhar, você recebe os benefícios do item, mas envelhece 1d4 anos e não pode mais usá-lo nesse dia.'
    },
    {
        id: 'morte-frasco-lodo',
        name: 'Frasco de Lodo',
        element: 'Morte',
        category: 2,
        spaces: 1,
        description: 'Um pequeno frasco contendo Lodo da Morte. Aplicar o conteúdo do frasco em um ferimento é uma ação padrão. Se aplicado em um ferimento recente (sofrido até uma rodada atrás) o Lodo recupera 6d8+20 pontos de vida. Caso a ferida seja anterior à rodada passada, role um dado: em um resultado par, o Lodo recupera 3d8+10 PV; em um resultado ímpar, a ferida infecciona, causando 3d8+10 pontos de dano de Morte. O frasco possui Lodo para uma única ativação.'
    },
    {
        id: 'morte-vislumbre-fim',
        name: 'Vislumbre do Fim',
        element: 'Morte',
        category: 2,
        spaces: 1,
        description: 'Um par de óculos escuros repleto de símbolos e espirais em sua armação metálica. Você pode gastar uma ação de movimento para se concentrar em um ser que esteja vendo e obter informações sobre a morte dele. Em pessoas comuns, essa informação se traduz em um contador de tempo, que pode se alterar conforme as ações de um Marcado modificam seu futuro. Em Marcados ou criaturas, essas informações se traduzem na informação de qual é o pior valor de resistência do alvo (entre Fortitude, Reflexos ou Vontade) e de quaisquer vulnerabilidades que o alvo possua.'
    },
    // CONHECIMENTO
    {
        id: 'conhecimento-aneis-elo-mental',
        name: 'Anéis do Elo Mental',
        element: 'Conhecimento',
        category: 2,
        spaces: 1,
        description: 'Um par de anéis dourados, cada um contendo um dos símbolos do ritual Ligação Telepática. Os anéis devem ser usados por duas pessoas por 24h para serem ativados. Após esse período, os dois são conectados por um ritual de Invadir Mente (ligação telepática) que dura enquanto estiverem usando os anéis. Enquanto a ligação estiver ativa, as duas pessoas fazem testes de Vontade usando a melhor quantidade de dados e bônus entre as duas. Porém, qualquer dano mental sofrido por uma delas será sofrido pela outra (ou seja, se numa rodada ambas sofrerem 10 pontos de dano mental, cada uma irá perder 20 pontos de sanidade) e qualquer condição mental ou de medo que afetar uma delas automaticamente afetará a outra.'
    },
    {
        id: 'conhecimento-lanterna-reveladora',
        name: 'Lanterna Reveladora',
        element: 'Conhecimento',
        category: 2,
        spaces: 1,
        description: 'Uma lanterna dourada decorada com sigilos do Outro Lado. Ativar a lanterna gasta uma ação padrão e 1 PE. Ela fica ligada por uma cena e emite luz com as propriedades do ritual Terceiro Olho. A luz da lanterna incomoda criaturas de Sangue. Se elas foram iluminadas pela luz dela, irão atacá-lo em detrimento de quaisquer outros alvos na mesma categoria de alcance.'
    },
    {
        id: 'conhecimento-mascara-pessoas-sombras',
        name: 'Máscara das Pessoas nas Sombras',
        element: 'Conhecimento',
        category: 2,
        spaces: 1,
        description: 'Principal ferramenta e marca registrada da Seita das Máscaras, esse item quando usado por alguém que não pertence à Seita ainda carrega grande poder. O usuário recebe resistência a Conhecimento 10 e pode gastar uma ação de movimento e 2 PE para “entrar” em uma sombra adjacente e se transportar instantaneamente para outra sombra que possa ver em alcance médio. Vestir a Máscara é como assinar um acordo e pode ter consequências severas se seu portador despertar o interesse da mente única das Máscaras...'
    },
    {
        id: 'conhecimento-municao-jurada',
        name: 'Munição Jurada',
        element: 'Conhecimento',
        category: 2,
        spaces: 1,
        description: 'Uma bala de arma de fogo com um sigilo gravado. O usuário pode fazer um ritual de uma hora para vincular essa munição a um ser que conheça. Se usada contra esse ser, a bala fornece +10 no teste de ataque, dobra a margem de ameaça da arma e causa +6d12 pontos de dano de Conhecimento. Possuir uma munição jurada deixa o usuário obcecado em abater seu alvo, impondo –2 em Defesa e em testes de ataque contra quaisquer outros alvos.'
    },
    {
        id: 'conhecimento-pergaminho-pertinacia',
        name: 'Pergaminho da Pertinácia',
        element: 'Conhecimento',
        category: 2,
        spaces: 1,
        description: 'Um pergaminho amarelado e antigo. Mesmo enrolado, é possível vislumbrar sigilos dourados brilhando na parte interior. Você pode gastar uma ação padrão para encarar os sigilos do Outro Lado inscritos no pergaminho, recebendo 5 PE temporários até o fim da cena. Sempre que usa este item, você deve fazer um teste de Ocultismo (DT 15 + 5 por uso adicional no mesmo dia). Se falhar, o pergaminho se desfaz.'
    },
    // ENERGIA
    {
        id: 'energia-arcabuz-moretti',
    ...
    {
        id: 'energia-relogio-arnaldo',
        name: 'Relógio de Arnaldo',
        element: 'Energia',
        category: 2,
        spaces: 1,
        description: 'Um relógio de ouro, meio manchado e com um aspecto levemente queimado no exterior. Ao abrir, é possível enxergar a foto de um homem de barba e óculos ao lado de uma criança simpática, também segurando um relógio de ouro. Uma vez por rodada, você pode gastar 1 PE para rolar novamente qualquer dado com o resultado 1. O custo para usar o relógio aumenta em +1 para cada vez que for ativado no mesmo dia. Este é um item único (apenas um agente pode escolhê-lo).'
    },
    {
        id: 'energia-talisma-sorte',
        name: 'Talismã da Sorte',
        element: 'Energia',
        category: 2,
        spaces: 1,
        description: 'Uma moeda, pé de coelho ou qualquer outro badulaque modificado por um ritual. Sempre que você estiver vestindo o talismã e sofrer dano, pode gastar uma reação e 3 PE para rolar 1d4. Em um resultado 2 ou 3, você evita completamente o dano. Em um resultado 4, você evita o dano, mas o talismã queima e vira cinzas. Por fim, em um resultado 1, a sorte se reverte em azar: em vez de evitar o dano, você sofre o dobro do dano que sofreria e o talismã queima e vira cinzas.'
    },
    {
        id: 'energia-teclado-conexao-neural',
